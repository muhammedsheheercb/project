    ...
    <>
      <div className="z-50 flex w-full flex-col items-center gap-2">
        <div className="embla-menu w-full">
          <div className="embla-menu__viewport" ref={emblaRef}>
            ...
            <div className="flex w-full items-center justify-center pb-6">
              {slides[selectedIndex]?.name && (
                <p className="font-lato min-h-[80px] max-w-[300px] text-center text-xl font-[300] text-[#fff]">
                  {formatModelName(slides[selectedIndex]?.name)}
                </p>
              )}
            </div>
        ...
        <div className="relative flex h-auto w-full items-center justify-end gap-2 px-10 md:px-64">
          <div className="absolute bottom-3 left-1/2 flex -translate-x-1/2 transform items-center gap-6 md:-bottom-6">
            <PrevButton
        ...
        {/* big screen */}
        {/* <div className="relative hidden h-auto w-full items-center justify-end gap-2 px-10 md:flex md:px-64">
          <div className="absolute bottom-10 left-40 flex items-center gap-6 hover:cursor-pointer 2xl:left-60">
            <PrevButton
              onClick={onPrevButtonClick}
              disabled={prevBtnDisabled}
            />
          </div>
          <div className="absolute bottom-10 right-40 flex items-center gap-6 hover:cursor-pointer 2xl:right-60">
            <NextButton
              onClick={onNextButtonClick}
              disabled={nextBtnDisabled}
            />
