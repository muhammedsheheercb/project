          ...
          <div className="mx-auto flex max-w-7xl flex-col items-center justify-center gap-3 p-3 md:flex-row md:gap-6 md:p-5 md:py-3">
            ...
            <div className="flex flex-shrink-0 items-center gap-2 md:gap-3">
              <button
                ...
                className="whitespace-nowrap px-3 py-2 text-xs font-medium transition-all duration-200 hover:bg-white/10 md:px-5 md:text-sm"
                style={{
              ...
              <button
                ...
                className="whitespace-nowrap px-4 py-2 text-xs font-medium transition-all duration-200 hover:opacity-90 md:px-6 md:text-sm"
                style={{
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <label className="relative inline-flex flex-shrink-0 cursor-pointer items-center">
          ...
          />
          <div
            className={`peer h-6 w-11 rounded-full transition-all after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:bg-white after:transition-all after:content-[''] peer-checked:after:translate-x-5 ${
